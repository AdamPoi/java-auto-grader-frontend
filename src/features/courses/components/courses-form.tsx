...
export function CourseForm({
    ...
    const mutation = isEditMode ? updateCourseMutation : createCourseMutation;
    const form = useForm<CourseForm>({
        ...
        defaultValues: initialData ? {
            ...
            assignmentIds: initialData.assignments?.map(assignments => assignments.id) || [],
    ...
    useEffect(() => {
        if (initialData) {
            form.reset({
                ...
                assignmentIds: initialData.assignments?.map(assignment => assignment.id) || [],
                isActive: initialData.isActive
            });
    ...
    const handleFormSubmit = (data: CourseForm) => {
