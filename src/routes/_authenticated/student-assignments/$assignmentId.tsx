...
import { SubmissionsForm } from '@/features/submissions/components/submissions-form';
...
function StudentAssignmentDetailPage() {
  ...
  const { assignmentId } = useParams({ from: '/_authenticated/student-assignments/$assignmentId' });
